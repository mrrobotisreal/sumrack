# sherpa-speech — local Expo module (T11)

On-device Russian speech for Сумрак, wrapping [sherpa-onnx](https://github.com/k2-fsa/sherpa-onnx):

- **TTS (this ticket, T11)**: Piper VITS Russian voices (Руслан / Ирина / Денис / Дмитрий), streamed to an `AudioTrack` as synthesis chunks arrive.
- **ASR (T12)**: lands in this same module.
